#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/src/transformers/models/qwen2_ple/modular_qwen2_ple.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_qwen2_ple.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class Qwen2PleExpertMLP(nn.Module):
...
class Qwen2PleAttention(nn.Module):
...
class Qwen2PleRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen2PleRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen2PleDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: Qwen2PleConfig, layer_idx: int):
        ...
        self.self_attn = Qwen2PleAttention(config=config, layer_idx=layer_idx)
        self.mlp = Qwen2PleMLP(config)
        self.input_layernorm = Qwen2PleRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = Qwen2PleRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
@auto_docstring
class Qwen2PlePreTrainedModel(PreTrainedModel):
    config: Qwen2PleConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Qwen2PleDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Qwen2PleDecoderLayer,
        "attentions": Qwen2PleAttention,
    }


class Qwen2PleRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: Qwen2PleConfig, device=None):
        super().__init__()
...
@auto_docstring
class Qwen2PleModel(Qwen2PlePreTrainedModel):
    ...
    def __init__(self, config: Qwen2PleConfig):
        ...
        self.norm = Qwen2PleRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Qwen2PleRotaryEmbedding(config=config)
...
@auto_docstring
class Qwen2PleForCausalLM(Qwen2PlePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Qwen2PleForCausalLM

        >>> model = Qwen2PleForCausalLM.from_pretrained("meta-qwen2_ple/Qwen2Ple-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-qwen2_ple/Qwen2Ple-2-7b-hf")
